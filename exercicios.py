...
pessoa = {
    ...
    "idade": 25,
    "cidade": "Ipiraporinha do Oeste",
    "profissão": "Mecânica de trens"
}
...
if "gato5" in gatos:
    print("A chave gato5 existe no dicionário.")
else:
    print("A chave gato5 não existe no dicionário.")
...
for palavra in palavras:
    if palavra in frequencia:
        frequencia[palavra] += 1     # já existe → soma +1
    else:
        frequencia[palavra] = 1      # primeira vez → define 1
        print(frequencia)
